<template>
    <form @submit.prevent="addTweet" class="my-12">
<!--    @CSFR    -->
...
<!--            </div>-->
            <button type="submit" class="inline-flex justify-center py-2 px-4 border-none border-transparent text-sm font-medium rounded-md text-white bg-none text-gray-400 hover:text-gray-700 focus:outline-none">Tweet</button>
        </div>
